# Problem 1: Sets - Social Media Friend Analysis 🌐
# Problem: You are building a social media analytics tool. Given user friendship data, you need to analyze relationships between users.

# Task: Create a function analyze_friendships() that takes friendship data and performs various analyses.
...
def analyze_friendships():
    ...
    facebook_only = facebook_friends - (instagram_friends | twitter_friends | linkedin_friends) # | -> union
    ...
    exactly_two_platforms = (
        (facebook_friends & instagram_friends) - (twitter_friends | linkedin_friends) |
        (facebook_friends & twitter_friends) - (instagram_friends | linkedin_friends) |
        (facebook_friends & linkedin_friends) - (instagram_friends | twitter_friends) |
        (instagram_friends & twitter_friends) - (facebook_friends | linkedin_friends) |
        (instagram_friends & linkedin_friends) - (facebook_friends | twitter_friends) |
        (twitter_friends & linkedin_friends) - (facebook_friends | instagram_friends)
    )
...
# ____________________________________NOTES________________________________
# A = {1, 2, 3}
# B = {3, 4, 5}
# print(A & B)  # Output: {3}
